...
function renderFilters() {
  ...
  // Focus (tags) and Era facets are disabled for now — they only cover
  // wiki-linked questions, so coverage is thin. The Group (overview
  // section) facet below supersedes them. Re-enable by flipping FACETS_ON
  // once tag/era coverage grows.
